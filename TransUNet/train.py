...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            'root_path': '/home/stone/dataset/tif/train',
            'label_dir': '/home/stone/dataset/tif/train_label',
            'num_classes': 9,
        },
    }
    ...
    print("------config_vit.pretrained_path:---------", config_vit.pretrained_path)
    ...
    # x=torch.rand(16,1,224,224).cuda()
    # -------eg1: view model-----------
    ...
    with open("transunet_loss.txt", "w") as file0:
        trainer = {'Synapse': trainer_synapse}
        trainer[dataset_name](args, net, snapshot_path, file0)
